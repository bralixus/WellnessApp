    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "Twoje hasło zostało ustalone"
                : message == ManageMessageId.SetTwoFactorSuccess ? "Ustanowiono dwustopniową autentykację"
                : message == ManageMessageId.Error ? "Błąd"
